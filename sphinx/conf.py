...
# -*- coding: utf-8 -*-
#
# inline-array documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'inline-array.tex', 'inline-array Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'inline-array', 'inline-array Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'inline-array', 'inline-array Documentation',
     author, 'inline-array', 'One line description of project.',
     'Miscellaneous'),
]
