...
If :code:`inline-array` is available in your opam repository, you can just call::

  opam install inline-array

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`inline-array` in a directory.
